...
#### **PROJECT DESCRIPTION**
  What is the effect of level of simulation fidelity on learning
...
ggplot(loglogPlot, aes(x = trials)) + 
  ...
  labs(x = "Blocks of 10 min.", y = "Response Time (s)",
       title = "Log Log Plot", 
       subtitle = "Figure 9",
...
ggplot(loglogPlot_v2, aes(x = trials)) + 
  geom_line(aes(y = RT, color="High", group= 1), size = 1) +
  ...
  scale_y_continuous(trans = 'log10') +
  labs(x = "Blocks of 10 min.", y = "Response Time (s)",
       title = "Log Log Plot v2", 
       subtitle = "Figure 10",
       caption = "Figure 10: This plot displays a loglog plot v2.") + 
  scale_x_continuous(breaks=c(1:10)) +
  ylim(1, 100) +
  theme(axis.text=element_text(size=14,face="bold"),axis.title=element_text(size=14,face="bold")) +
  theme(legend.title=element_blank(), 
...
print (loglogPlot_v2)# Print data from log log dataframe
